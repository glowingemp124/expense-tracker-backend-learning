// emailTemplate.js
const APP_NAME = "Muslim App"; // Define the app name as a constant at the top
	...
	<tr>
		<td colspan="2" style="padding:20px 20px 20px 20px">
			...
			<p style="font-family: 'Montserrat', sans-serif;font-size: 15px;text-align: justify;">
				You’re almost ready to start a whole new muslimapp experience
			</p>
			<p style="font-family: 'Montserrat', sans-serif;font-size: 15px;text-align: justify;">
			...
			<p style="font-family: 'Montserrat', sans-serif; font-size: 15px;">
				We wish you a Muslim App experience
			</p>
         <p style="font-family: 'Montserrat', sans-serif; font-size: 15px;">
        Best Regards,
        <br>
